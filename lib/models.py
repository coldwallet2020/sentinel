...
class Proposal(GovernanceClass, BaseModel):
    ...
    govobj_type = BILLIECOIND_GOVOBJ_TYPES['proposal']
    ...
    def is_valid(self):
        ...
        try:
            ...
            # Billiecoin Core restricts proposals to 512 bytes max
...
class Superblock(BaseModel, GovernanceClass):
    ...
    govobj_type = BILLIECOIND_GOVOBJ_TYPES['superblock']
